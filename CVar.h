...
public:
	const char* GetString()
	{
		...
		return g_Utils->get_vfunc<GetString_t>(this, 11)(this);
	}
	bool GetBool() { return !!GetInt(); }
	float GetFloat()
	{
		typedef float(__thiscall* GetFloat_t)(void*);
		return g_Utils->get_vfunc <GetFloat_t>(this, 12)(this);
	}

	int GetInt()
	{
		typedef int(__thiscall* GetInt_t)(void*);
		return g_Utils->get_vfunc <GetInt_t>(this, 13)(this);
	}

	void SetValue(const char *value)
	{
		typedef void(__thiscall* SetValue_t)(void*, const char*);
		return g_Utils->get_vfunc<SetValue_t>(this, 14)(this, value);
	}

	void SetValue(float value)
	{
		typedef void(__thiscall* SetValue_t)(void*, float);
		return g_Utils->get_vfunc<SetValue_t>(this, 15)(this, value);
	}

	void SetValue(int value)
	{
		typedef void(__thiscall* SetValue_t)(void*, int);
		return g_Utils->get_vfunc<SetValue_t>(this, 16)(this, value);
	}
	...
	*/
	...
	char* GetName()
	{
		...
		return g_Utils->get_vfunc<OriginalFn>(this, 5)(this);
	}
