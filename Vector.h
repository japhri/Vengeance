...
#define radf(a) a*(static_cast<float>(M_PI)/180)
...
{
	return Vector(cos(y * static_cast<float>(M_PI) / 180.0f) * cos(x * static_cast<float>(M_PI) / 180.0f), sin(y * static_cast<float>(M_PI) / 180.0f) * cos(x * static_cast<float>(M_PI) / 180.0f), sin(-x * static_cast<float>(M_PI) / 180.0f)).NormalizeVec();
}
