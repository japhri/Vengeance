...
public:
	...
	void                   DrawFilledRectFade(int x0, int y0, int x1, int y1, unsigned int alpha0, unsigned int alpha1, bool bHorizontal)
	{
		...
		g_Utils->get_vfunc<fn>(this, 123)(this, x0, y0, x1, y1, alpha0, alpha1, bHorizontal);
	}

	void unlockcursor()
	{
		typedef void(__thiscall* OriginalFn)(void*);
		g_Utils->get_vfunc< OriginalFn >(this, 66)(this);
	}
	void lockcursor()
	{
		typedef void(__thiscall* OriginalFn)(void*);
		g_Utils->get_vfunc< OriginalFn >(this, 67)(this);
	}
};
...
public:
	const char* GetName(unsigned int Panel)
	{
		...
		return g_Utils->get_vfunc<Fn>(this, 36)(this, Panel);
	}
